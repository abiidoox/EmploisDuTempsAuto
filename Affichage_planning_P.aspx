<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Affichage_planning_P.aspx.cs" Inherits="Affichage_planning_P" %>
                    ...
                    <div class="row ">
                        <div class="col-12 mt-3 exercice-sec pt-2 m-1" style="display: inline">
                            ...
                            <div class="row mt-5">
                                ...
                                <div class="col-3">
                                    <asp:Button ID="Button2" runat="server" Text="Générer la base d'emploie" Visible="false" CssClass="btn btn-btn" OnClick="Button2_Click" />
                                </div>
                                <div class="col-3">
                                    <asp:Button ID="Button3" runat="server" Text="Inserer à la base" Visible="false" CssClass="btn btn-btn" OnClick="Button3_Click" />
                                </div>
                            </div>
                            ...
                            <div class="row mt-5">
                                <div class="col-12">
                                    <asp:GridView ID="dgv_PlanningAlgo" runat="server" CssClass="table" AllowPaging="false"
                                        CellPadding="4" ForeColor="#333333" GridLines="None">
                                        <AlternatingRowStyle BackColor="White" />
                                        <EditRowStyle BackColor="#2461BF" />
                                        <FooterStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
