<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Affichage_Selection.aspx.cs" Inherits="Affichage_Selection" %>
    ...
    <div class="container" style="max-width: 1200px !important;">
        <div class="row justify-content-center mt-4">
            <div class="col-8 mt-5  mb-1 bg-white p-5 rounded shadow border" style="width: 80% ">
                <h5 style="font-weight: bold; font-size: 23px;">Choisir le mode D'affichage :</h5>
                        ...
                        <div class="col-sm-6" style="">
                            <div class="card" >
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Afficher l'emploi du temps Par Formateur</p>
                                    <a href="Affichage_Local1.aspx" class="btn btn-btn">Entrer →</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="card" >
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Afficher l'emploi du temps Par Groupe</p>
                                    <a href="Affichage_Local2.aspx" class="btn btn-btn">Entrer →</a>
                                </div>
                            </div>
                        </div>
