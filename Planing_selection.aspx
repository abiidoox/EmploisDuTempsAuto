<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Planing_selection.aspx.cs" Inherits="Planing_selection" %>
                        ...
                        <div class="col-sm-6" style="">
                            <div class="card" >
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Charger la base des plannings du mode (P)</p>
                                    <a href="Affichage_Planning_P.aspx" class="btn btn-btn">Entrer →</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="card" >
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Charger la base des plannings du mode (FAD)</p>
                                    <a href="Affichage_Planning_fad.aspx" class="btn btn-btn">Entrer →</a>
                                </div>
                            </div>
                        </div>
