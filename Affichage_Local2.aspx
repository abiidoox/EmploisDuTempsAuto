<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Affichage_Local2.aspx.cs" Inherits="Affichage_Local2" %>
...
<body style="background-color: #f0f0f0">
    ...
    <asp:DropDownList ID="DropDownListmois0" runat="server" AutoPostBack="True"
        ...
        <asp:ListItem Value="8">Aout</asp:ListItem>
                                ...
                                &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; <span class="col-form-label h5" style="">Groupe :</span>
                                <asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True"
                                    DataSourceID="SqlDataSource2" DataTextField="Nom" DataValueField="idgroupe"
                                    Height="47px" Width="357px" Font-Bold="True" OnDataBound="DropDownList1_DataBound" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged">
                                </asp:DropDownList>

                                <asp:SqlDataSource ID="SqlDataSource2" runat="server"
                                    ConnectionString="<%$ ConnectionStrings:db_gestion_achats3ConnectionString %>"
                                    SelectCommand="select idgroupe,Nom from groupes where anneeformation='2021/2022' and etablissement ='p200'"></asp:SqlDataSource>
